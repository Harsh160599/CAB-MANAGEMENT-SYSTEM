 ...
 <h1>View Cab Fares</h1>
    <table border="1">
        ...
        <c:forEach items="${cabFareList}" var="cabFare">
            <tr>
                <td>${cabFare.id}</td>
                <td>${cabFare.fromLocation}</td>
                <td>${cabFare.toLocation}</td>
                <td>${cabFare.fare}</td>
                <td>
                    <form action="/delcabfare/${cabFare.id}" method="get">
                        <button type="submit">Delete</button>
                    </form>
                    <br>
                     <form action="/editcabfare/${cabFare.id}" method="get">
